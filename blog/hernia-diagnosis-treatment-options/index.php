...
<!-- End Google Tag Manager -->
      ...
      <title>Hernia: Types, Symptoms, Diagnosis & Treatment Options</title>
      <meta name="description" content="A hernia is a common problem & can happen to anyone. Learn about common types of hernias, their symptoms, diagnosis & treatment options.">
      <meta property="og:description" content="A hernia is a common problem & can happen to anyone. Learn about common types of hernias, their symptoms, diagnosis & treatment options.">
      <meta property="og:type" content="Blog">
      <meta property="og:title" content="Hernia: Types, Symptoms, Diagnosis & Treatment Options">
      <meta property="og:url" content="https://cmclancaster.com/blog/hernia-diagnosis-treatment-options/">
      <meta property="og:site_name" content="CMC Lancaster">

<meta property="article:publisher" content="https://www.facebook.com/cmcl.us" />
<meta property="article:tag" content="Hernia" />
<meta property="article:tag" content="Hernia Treatment" />
<meta property="article:tag" content="Hernia Pain" />
<meta property="article:tag" content="Hernia Repair Surgery" />
<meta property="article:tag" content="type of hernia" />
<meta property="article:tag" content="Diagnosis of hernias" />
<meta property="article:tag" content="Laparoscopic surgery" />
<meta property="article:tag" content="inguinal hernia" />
<meta property="article:tag" content="hiatal hernia" />
<meta property="article:tag" content="umbilical hernia" />
<meta property="article:tag" content="Incisional hernias" />




      <meta name="twitter:card" content="summary">
      <meta name="twitter:title" content="Hernia: Types, Symptoms, Diagnosis & Treatment Options">
      <meta name="twitter:description" content="A hernia is a common problem & can happen to anyone. Learn about common types of hernias, their symptoms, diagnosis & treatment options." >

      <link rel="canonical" href="https://cmclancaster.com/blog/hernia-diagnosis-treatment-options/">
      <link rel="alternate" href="https://cmclancaster.com/blog/hernia-diagnosis-treatment-options/" hreflang="en-us" />
...
"mainEntityOfPage":{
"@type":"WebPage",
"@id":"https://cmclancaster.com/blog/hernia-diagnosis-treatment-options/"
},
"headline": "Hernia: Types, Symptoms, Diagnosis & Treatment Options",
"image": {
"@type": "ImageObject",
"Url": "",
"height": 292,
...
"publisher": {
"@type": "Organization",
"name": "Crescent Medical Center",
"logo": {
"@type": "ImageObject",
"url": "https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/crescent/assets/images/logo-new.png"
}
},
"description": "A hernia is a common problem & can happen to anyone. Learn about common types of hernias, their symptoms, diagnosis & treatment options.", 
"articleBody": "Hernias, the funny little bulges or lumps that some people have on their abdomen, groin, or even scrotum,  are one of those common and benign health abnormalities that remain painless and harmless in some people for a long time since birth. However, they can be a matter of discomfort and pain in many others and requires immediate surgery called hernia repair. A hernia can be congenital (originated from before your birth) or acquired due to the weakened abdomen or due to an injury. It can be external, protruding toward the outside of our body or internal, when it pushes deep under the skin. They can be pushed into and usually disappear when we lie down. "
}
</script>
...
<div class="bg bg-image" style="background-image: url('https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/crescent/assets/images/hernia-repair.jpg'); background-position: 49% 48%;" alt="bcg therapy"></div>
               <div class="row">
                  <div class="column">
                     <div class="page-banner-content">
                        <h1><span class="dotted-underline">Hernia</span></h1>
                        <!-- <p>
...
<ul>
<li>A soft lump or bulge in the groin or abdomen that you can hold and play with.</li>
<li>A bulge in the groin or scrotum in men.</li>
<li>A bulge that can be pushed back in or disappears when lying down.</li>
<li>A bulge that increases in the size slowly over time.</li>
<li>Pain or a burning or aching sensation at the site of the bulge</li>
<li>Pain while coughing, bending over, or lifting heavy objects</li>
<li>A heavy feeling in your groin.</li>

</ul>

</p>
<p>However, the bulges or lumps occur in cases of external or outward hernias only. There can be internal hernias where the protrusions are inward, and therefore do not result in any bulge on our body surface. </p>

<h2 class="blogh2">Why a hernia happens?</h2>
<p>Organs in our body such as small and large intestines, stomach, liver, etc. are kept in place by a thin muscular lining called peritoneum and a set of tissues called mesentery. A peritoneum layer also runs over the inner surface of our abdominal wall that may develop some weak spots due to bad health or strain.  </p>
<p>
A hernia is an abnormal displacement of an internal tissue or organ through the weakened lining of the abdominal wall. For example, it can be a portion of the small intestine or bowel that has pushed through a weak spot in the peritoneum on the inner side of the abdominal wall. </p>

<h2 class="blogh2">
Factors that may cause peritoneum weakness include:</h2>
<p>
  <ul>
<li>A congenital defect such as failure of the abdominal wall to close properly in the womb, </li>
<li>Age</li>
<li>Frequent coughing and sneezing</li>
<li>Injury </li>
<li>Surgery
</li></ul>
</p>

<h2 class="blogh2">Causes of strain that lead to a hernia, especially if your muscles are weak, include:</h2>

<p>
  <ul>
<li>The pregnant condition that puts pressure on your abdomen</li>
<li>Strain when having a bowel movement, due to constipation</li>
<li>Lifting heavyweight</li>
<li>Fluid in the abdomen, or ascites</li>
<li>Sudden weight gain</li>
<li>Surgery in the area</li>
<li>Persistent coughing or sneezing</li>

  </ul>
</p>
<p>A hernia can be congenital (originated from before your birth) or acquired due to the weakened abdomen or due to an injury. It can be external, protruding toward the outside of our body or internal, when it pushes deep under the skin. They can be pushed into and usually disappear when we lie down.
</p>
...
<p>
<h3 class="blogh3">An inguinal hernia</h3>  
<p>The most common type of hernias occur when intestines push through the lower abdominal wall near the inguinal canal. </p>
<h3 class="blogh3">A hiatal hernia</h3> <p> A hiatal hernia is caused if a part of our stomach protrudes up through the diaphragm into the chest cavity.</p>
<h3 class="blogh3">An umbilical hernia</h3> <p> This type of hernias are sometimes seen in babies under six months and caused when a portion of their intestine pokes out through the abdominal wall near their belly button, creating a bulge.</p>
<h3 class="blogh3">Incisional hernias</h3> <p> This type of hernia may occur after abdominal surgery. Your intestines may find the seam line in the abdomen as a weak spot and try to push through it. </p>

<h2 class="blogh2">Diagnosis of hernias:</h2>
<p>
  For the inguinal or incisional hernias, diagnoses are pretty simple. Your doctor will check your body physically and feel the bulge in your abdomen or groin that gets larger when you stand, cough, or strain but disappears when you lie down.</p>
<p>
Since the hiatal hernias are directed inward and do not create any bulge on the skin, the doctors use barium X-ray or endoscopy to diagnose them. Both are painless methods.
In a barium X-ray process, a series of pictures of your digestive tract are taken after you are made to drink a liquid solution containing barium, to get better X-ray images.  
  <a href="https://cmclancaster.com/blog/endoscopy-procedure/" target="_blank"> Endoscopy</a> involves pushing a thin and flexible pipe down your throat to take pictures of your stomach position.</p>
<p>
...
<h2 class="blogh2">Treatment options:</h2>
<p>Some hernias may not have any symptom for a long time, during when you may decide to wait and watch. But for certain types of hernias such as femoral hernias, if treatments are delayed there can be a chance of bowel strangulation within 2 years of time. </p>
<p>
It is recommended to surgically repair a hernia to preempt the bowel strangulation because this is a complication where blood supply is cut off to an area of the intestine and requires an emergency procedure. </p>
<p>
The common hernia repair is done by patching the hole in the abdominal wall with the surgical mesh to close the path of a hernia. This can be done by laparoscopic surgery as well as open surgery. Laparoscopic surgery offers much quicker recovery and returns to work than the open surgery.</p>
   ...
   <!-- lang translator css end --> 
      ...
      <script type='text/javascript'>
         ...
         // jQuery(document).ready(function($) {
                                  //$("#user_phone").inputmask({"mask": "9-(999) 999-9999"});
