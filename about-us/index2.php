...
<html lang="en-us">
   ...
   <head>
      ...
      <title>MESSAGE FROM THE CEO- Crescent Medical Center Lancaster </title>
      <!-- Google Tag Manager -->
...
<!-- End Google Tag Manager -->
   ...
   <meta name="description" content="Read the message from Our President Khalid Mahmood, M.D. - Responsible for providing the very best care and best experience to everyone, every time.  We work closely with patients to continuously improve health and well-being">
      <meta property="og:description" content="Read the message from Our President Khalid Mahmood, M.D. - Responsible for providing the very best care and best experience to everyone, every time.  We work closely with patients to continuously improve health and well-being" >
      <meta property="og:type" content="website">
      <meta property="og:title" content="MESSAGE FROM THE CEO - Crescent Medical Center Lancaster ">
      <meta property="og:url" content="https://cmclancaster.com/ceo-message/">
      
      <meta property="og:site_name" content="CMC Lancaster">
      <meta name="twitter:card" content="summary">
      <meta name="twitter:title" content="MESSAGE FROM THE CEO - Crescent Medical Center Lancaster"  >
      <meta name="twitter:description" content="Read the message from Our President Khalid Mahmood, M.D. - Responsible for providing the very best care and best experience to everyone, every time.  We work closely with patients to continuously improve health and well-being" >

      <link rel="canonical" href="https://cmclancaster.com/ceo-message/">
      <link rel="alternate" href="https://cmclancaster.com/ceo-message/" hreflang="en-us" />
...
<!-- new lang trans -->
<div class="translatediv" id="translatediv">
         ...
         <main id="main" class="main-content" role="main">
            <section class="page-banner page-banner-landing full-page">
               <div class="bg bg-image"
                  style="background-image: url('https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/crescent/assets/images/letterhome.jpg');
                  background-position: 49% 48%;"
                  ></div>
               <div class="row">
                  <div class="column">
                     <div class="page-banner-content">
                        <h1><span class="dotted-underline">MESSAGE FROM THE CEO</span></h1>
               ...
               <div class="page-banner-social">
                <a href="https://business.facebook.com/cmcl.us/?business_id=852487431465578" target="_blank" rel="nofollow external" class="icon icon-facebook-with-circle"></a>
                     ...
                     <a href="https://www.linkedin.com/company/crescent-medical-center-lancaster" target="_blank" rel="nofollow external" class="icon icon-linkedin-with-circle"></a>
                      ...
                      <a href="https://www.instagram.com/crescentmedicalcenterlancaster/?hl=en" target="_blank" rel="nofollow external" class="icon"><i class="insta fa fab fa-instagram"></i></a>
                  ...
                  <div class="column large-10 large-centered">
                     <ul class="breadcrumbs">
                      ...
                      <!--   <li class="active">Services</li> -->
                        <li class="active">MESSAGE FROM THE CEO</li>
            ...
            <section class="content-block content-block-left-image-content  grey-bg" data-equalizer>
               <div class="content-block-content-wrap md-width" data-equalizer-watch>
                  <div class="content-block-content p1">
                     <p class="sub-title"></p>
                     <p class="title">MESSAGE FROM THE CEO</p>
                     <div class="text">
                         <p>We are proud to have served Lancaster and the surrounding communities since 2013, celebrating our 5th anniversary this past June.</p>
<p>The mission of Crescent Medical Center Lancaster is to restore and improve human life through compassionate healthcare.  Our staff is focused on making sure each and every patient has an excellent experience, and that the families with them feel welcomed and served.
</p>
<p>
We will continue to look for opportunities to expand the services offered here at the hospital, providing physician specialties not found elsewhere in the community.
<br>

<strong>Thank you for your support.</strong> <br><br>
...
CEO</p>
              ...
              <!--  <div class="content-block-image" style="
                  background-image: url('https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/crescent/assets/images/letter1.jpg');
                 
                  background-size:cover;"
                  data-equalizer-watch
                  ></div> -->

                   <div class="content-block-image md-width-img p1-img" style="text-align: center;">
                     <img src="https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/crescent/assets/images/letter1.jpg">
               ...
               <div class="latest-news-region-inner">
                  <div class="row">
                     ...
                     <a href="https://www.linkedin.com/company/crescent-medical-center-lancaster/about/" target="_blank" rel="nofollow external" class="icon icon-linkedin-with-circle"></a>
                      ...
                      <a href="https://www.instagram.com/crescentmedicalcenterlancaster/?hl=en" target="_blank" rel="nofollow external" class="icon"><i class="instaf fa fab fa-instagram"></i></a>
 ...
 <script> function googleTranslateElementInit() {new google.translate.TranslateElement({pageLanguage: 'en', includedLanguages: 'en,es', layout: google.translate.TranslateElement.InlineLayout.SIMPLE, autoDisplay: true, multilanguagePage: false}, 'google_translate_element');
}
