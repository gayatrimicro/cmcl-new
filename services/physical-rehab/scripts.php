<?php 
	...
	// $headers .= 'Bcc: birthdaycheck@example.com' . "\r\n";
	   	...
	   	$message= "<table border='0' cellpadding='4' cellspacing='4' width='100%'>
				   ...
				   $phone = $_POST["phone1"] . $_POST["phone2"] . $_POST["phone3"];
				mail("physicalrehab@cmclancaster.com", $subject, $message, $headers);
				...
				VALUES (NULL, '$name', '$lastname', '$email', '$message1', NULL, '$phone', NULL, 'services > physical-rehab', '1', NULL, now(), NULL, now(), NULL, NULL)");
