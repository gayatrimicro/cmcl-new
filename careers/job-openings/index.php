...
<html lang="en-us">
   ...
   <head>
      ...
      <title>Job Openings | Crescent Medical Center, Lancaster TX</title>
      <!-- Google Tag Manager -->
...
<!-- End Google Tag Manager -->
    ...
    <meta name="description" content="If you are looking to work or make a career with a multi specialist hospital in Texas, then Best Healthcare Jobs can be found here. Crescent Medical Center is where you should be. Find out our current job openings">
      <meta property="og:description" content="If you are looking to work or make a career with a multi specialist hospital in Texas, then Best Healthcare Jobs can be found here. Crescent Medical Center is where you should be. Find out our current job openings">
      <meta property="og:type" content="website">
      <meta property="og:title" content="Job Openings | Crescent Medical Center, Lancaster TX">
      <meta property="og:url" content="https://cmclancaster.com/careers/job-openings/">
    
      <meta property="og:site_name" content="CMC Lancaster">
      <meta name="twitter:card" content="summary">
      <meta name="twitter:title" content="Job Openings | Crescent Medical Center, Lancaster TX"  >
      <meta name="twitter:description" content="If you are looking to work or make a career with a multi specialist hospital in Texas, then Best Healthcare Jobs can be found here. Crescent Medical Center is where you should be. Find out our current job openings" >
      <link rel="canonical" href="https://cmclancaster.com/careers/job-openings/">
      <link rel="alternate" href="https://cmclancaster.com/careers/job-openings/" hreflang="en-us" />
         ...
         <main id="main" class="main-content" role="main">
            <section class="page-banner page-banner-landing full-page">
               <div class="bg bg-image"
                  style="background-image: url('https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/crescent/assets/images/openinghome.jpg');
                  background-position: 49% 48%;"
                  ></div>
               <div class="row">
                  <div class="column">
                     <div class="page-banner-content">
                        <h1><span class="dotted-underline">Job Openings
</span></h1>
                        <p>
            ...
            <section class="page-content">
               <div class="row">
                  <div class="column large-10 large-centered">
                     ...
                     <p>We are always on the look out for talented and gifted individuals that would like to start a career path at Crescent Medical Center Lancaster. As a community hospital we strive to hire people that will not only help us to grow as a hospital, but also add to our medical family. Crescent offers competitive salaries as well as full benefits to all of their employees.</p>
<p>Below you will find a list of current open positions. Please click the link to the right labeled SEND US YOUR RESUME to apply, and we will get back get back to you at our earliest convenience. You can download Employment Application by <a href="../../assets/pdf/employment-applicaion-2017.doc" target="_blank">Clicking Here.</a> 
                     </p>
                  </div>
               </div>
            </section>
           <?php
            $i=2;
            $data1 =mysqli_query($conn,"SELECT * FROM `carrier_details` where status = 1 ORDER BY `sequence_by` + 0  ASC ");
            if(mysqli_affected_rows($conn)){
            while($data=mysqli_fetch_array($data1)){
            if($i % 2){
               $class="content-block content-block-content-right-image";
            }else{
            $class="content-block content-block-left-image-content grey-bg";
         }
            $i++;
            ?>

            <section class="<?php echo $class ;?>" data-equalizer>
               <div class="content-block-content-wrap" data-equalizer-watch style="width: 100%"> 
                  <div class="content-block-content">
                     <p class="sub-title"></p>
                     <p class="title"><?php echo $data['carrier_title'];?></p>
                     <div class="text">
                        <p style="color: #ee3124">
                           <?php echo $data['carrier_sub_title'];?></p>
                        <p>
                           <?php echo $data['carrier_description'];?>
                        </p>

                        <p>
                           <!-- <form action="apply.php" method="post">
                           <button class="button small" type="submit">Apply now</button>
                           <input type="hidden" name="carrier_id" value="<?php echo  $data['carrier_id'];?>">
                           </form> -->
                           <a  class="button small btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" data-id="<?php echo  $data['carrier_id'];?>">Apply</a>
                        </p>
                     </div>
                  </div>
               </div>
           ...
           <div class="modal-dialog modal-lg">
             ...
             <div class="modal-content">
               <div class="modal-header">
                 ...
                 <h4 class="modal-title">Apply Carrier</h4>
               </div>
   ...
   <!-- lang translator css end --> 
      ...
      <script type="text/javascript">
       ...
       <script type="text/javascript">
           ...
           var iSize = ($('input[name="upload_doc"]')[0].files[0].size); 
           if(iSize <= 500000){
            var myfile= $('input[name="upload_doc"]').val();
            var ext = myfile.split('.').pop();
            if(ext=="pdf" || ext=="docx" || ext=="doc"){
                
            } else{
               alert("Please Select Pdf AND Doc File Only..");
               return false;
            }
            }else{
