...
<!DOCTYPE html>
   ...
   <html lang="en">
      ...
      <head>
         ...
         <title>Medical Records | Crescent Medical Center Lancaster</title>
      <!-- Google Tag Manager -->
...
<!-- End Google Tag Manager -->
         ...
         <meta name="description" content="Here is what clients want to say about us" />
         <meta property="og:type" content="Website" />
         <meta property="og:title" content="Reviews | Crescent Medical Center Lancaster" />
         <meta property="og:description" content="Here is what clients want to say about us" />
         <meta property="og:url" content="https://cmclancaster.com/news/reviews/" />
         <meta property="og:site_name" content="CMC Lancaster" />
         <meta name="twitter:card" content="summary" />
         <meta name="twitter:title" content="Reviews | Crescent Medical Center Lancaster"  >
         <meta name="twitter:description" content="Here is what clients want to say about us" >
      ...
      <script type="text/javascript">
        ...
        /*.products:before{
            ...
            width: 22px;
            height: 16px;
            background: transparent url(https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/crescent/assets/images/quote-start.svg) center center no-repeat;
            position: absolute;
        ...
        .products:after{
            ...
            width: 22px;
            height: 16px;
            background: transparent url(https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/crescent/assets/images/quote-end.svg) center center no-repeat;
            position: absolute;
       ...
       <!--  language translator header end -->
            <section class="page-banner ">
               <div class="bg bg-image"
                  style="background-image: url('../assets/images/recordshome.jpg');
                  background-position: 49% 20%;"
                  ></div>
               <div class="row">
                  <div class="column">
                     <div class="page-banner-content">
                        <h1><span class="dotted-underline">Medical Records</span></h1>
                        <p></p>
                     </div>
                  </div>
               </div>
             ...
             <section class="latest-news-region grey-bg">
               <div class="latest-news-region-inner">
                ...
                <div class="grid">
                  <div class="reviews-heading">How to Access Medical Records</div><br>
                    <div class="card">
                      <!-- <img src="https://www.nm.org/~/media/Northwestern/healthbeat/images/patient-stories/nm-sports-medicine-helps-marathoner_preview2.jpg" style="margin-bottom: 50px;"> -->
                        <div class="products">
                          <div class="product active" product-id="1" product-color="#D18B49">
                            <!-- <img src="https://www.nm.org/~/media/Northwestern/healthbeat/images/patient-stories/nm-sports-medicine-helps-marathoner_preview2.jpg" style="margin-bottom: 50px;width: 100%"> -->
                            <p class="description">If you wish to have copies of your medical records released, please provide a 72-hour advance notice. You may request copies of your medical record between 8 A.M. and 4:30 P.M., Monday through Friday, by calling <a href="tel:972-230-8888">972-230-8888 </a> or by emailing <a href="mailto:recordrequest@cmclancaster.com">recordrequest@cmclancaster.com</a>. We will need your signed authorization for any release. As service to our patients, copies of medical records for continuing medical care are provided free of charge. Your medical records can also be burned to a CD for your use or to take to another care provider.
                            <br>
                    ...
                    <div class="column fl-right">
                     <div class="subscribe-form fl-r">
                        <div role="form" class="wpcf7" id="wpcf7-f857-o1" lang="en-US" dir="ltr">
                           ...
                           <form action="https://cmclancaster.com/function.php" method="post" >
                              ...
                              <input type="hidden" name="redirect" value="https://cmclancaster.com/medical-records/"> 
