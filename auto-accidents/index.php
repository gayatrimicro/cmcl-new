...
<html lang="en-us">
   ...
   <head>
      ...
      <title>Car Injury Doctors | Auto Accidents Injury | CMC Lancaster</title>
      <!-- Google Tag Manager -->
  ...
  "@graph": [
    ...
    },
    {
     ...
     "name" : "CMC Lancaster",
      ...
      "openingHours": "24/7",
      "image": "https://cmclancaster.com/assets/images/shutterstock_250536799.jpg",
      "priceRange": "$$$" 
    }
    ]
    }
         ...
         <main id="main" class="main-content" role="main">
            <section class="page-banner page-banner-landing full-page">
               <div class="bg bg-image"
                  style="background-image: url('../assets/images/shutterstock_250536799.jpg');"
                  ></div>
              <div class="row">
                  <div class="column">
                     <div class="page-banner-content">
                        <h1><span class="dotted-underline">Auto Accidents
</span></h1>
                        <p>
                  ...
                  <div class="column large-10 large-centered">
                     <ul class="breadcrumbs">
                       ...
                       <!--  <li class="active">Services</li> -->
                        <li class="active"> Auto Accidents </li>
     ...
     <!-- <section class="content-block content-block-full-backdrop  show-icon" style="
               ...
               <div class="row">
                  <div class="content-block-content small-10 large-8 small-centered column get_in_touch_content" >
                     ...
                     <p class="title git_footer">Contact a car wreck doctor today!</p>
                     <div class="text">
