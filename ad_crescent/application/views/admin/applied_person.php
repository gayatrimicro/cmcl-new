                        ...
                        if(!empty($person)){
                          ...
                          <tr>
                            <td><?php echo $sr++;?></td>
                              <td> <?php
                              $obj =& get_instance();
                              $job = rtrim($obj->get_data('carrier_details','carrier_id',$value['carrier_id'],'carrier_title'),':');
                              echo $obj->get_data('carrier_details','carrier_id',$value['carrier_id'],'carrier_title');
