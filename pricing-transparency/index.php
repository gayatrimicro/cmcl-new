...
<html lang="en">
   ...
   <head>
      ...
      <title>Pricing Transparency - Crescent Medical Center Lancaster TX</title>
      <!-- Google Tag Manager -->
...
<style type="text/css">
    ...
    /*float: center !important;*/
        border-bottom: 4px solid #4c7b2b;
    border-radius: 19px;
}
...
<!-- End Google Tag Manager (noscript) -->
         ...
         <main id="main" class="main-content" role="main">
            <section class="page-banner page-banner-landing full-page">
               <div class="bg bg-image"
                  style="background-image: url('https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/crescent/assets/images/pricing.jpg');
                  background-position: 49% 48%;"
                  ></div>
               <div class="row">
                  <div class="column">
                     <div class="page-banner-content">
                        <h1><span class="dotted-underline">Pricing Transparency</span></h1>
                        <p>
                      <!--   <p>
 WE ARE LOOKING FOR EXPERTISE & EXPERIENCE
  ...
  <div class="latest-news-region-inner">
    <div class="row">
      <div class="column latest-news-region-content">
        ...
        <ul class="small-block-grid-1 medium-block-grid-3 large-block-grid-3" data-equalizer data-options="equalize_on_stack: true">
                ...
                <div class="news-card">
                  <p>
                    <a href="https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/crescent/assets/pdf/Pricing-Transparency.csv" target="_blank">
                 
                  <div class="card-content">
                    <div class="card-inner" data-equalizer-watch>
                    
                      <p class="card-title">Pricing Transparency</p>
                      <p><a href="https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/crescent/assets/pdf/Pricing-Transparency.csv" target="_blank">
                                         <img src="https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/crescent/assets/images/csv.png" style="width: 167px;height:168px;"></a>
                ...
                <li style="width: 65.333333% !important; text-align: left !important;">
                 <!--  <div class="card-content">
                    <div class="card-inner" data-equalizer-watch> -->
    ...
    letter-spacing: 1px;
    padding-bottom: 20px;
    padding-top: 15px; text-align: left !important">DISCLAIMER AND EXPLANATION FOR STANDARD HOSPITAL CHARGES</p>
                    <p style="text-align: left !important;">This hospital determines its standard charges for patient services with the use of a chargemaster or similar system, which is a list of charges for the components of patient care that go into every patient’s bill. These are the baseline rates for services provided at this hospital. </p>
<p style="text-align: left !important;">
The chargemaster is similar in concept to the manufacturer’s suggested retail price (MSRP) on a vehicle. It is the starting price of each service performed and goods consumed associated with the individual patient’s treatment.  The chargemaster rates are updated from time to time to accurately reflect the hospital’s expenses to operate.</p>
<p style="text-align: left !important;">
                     ...
                     <div class="subscribe-form fl-r">
                        <div role="form" class="wpcf7" id="wpcf7-f857-o1" lang="en-US" dir="ltr">
                           ...
                           <form action="https://cmclancaster.com/function.php" method="post" >
                              ...
                              <input type="hidden" name="redirect" value="https://cmclancaster.com/pricing-transparency/"> 
