...
<html lang="en">
   ...
   <head>
      ...
      <title>Insurance Acceptance - Crescent Medical Center Lancaster TX</title>
      <!-- Google Tag Manager -->
         ...
         <main id="main" class="main-content" role="main">
            <section class="page-banner page-banner-landing full-page">
               <div class="bg bg-image"
                  style="background-image: url('https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/crescent/assets/images/insuhome.jpg');
                  background-position: 49% 48%;"
                  ></div>
               <div class="row">
                  <div class="column">
                     <div class="page-banner-content">
                        <h1><span class="dotted-underline">Insurance Acceptance</span></h1>
                        <p>
                      <!--   <p>
                ...
                <div class="news-card">
                  ...
                  <div class="card-content">
                    <div class="card-inner" data-equalizer-watch>
                      ...
                      <p class="card-title">CMCL Contracted Insurances</p>
                      <p><a href="https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/crescent/assets/pdf/CMCL-Contracted-Insurances-11-09-2018.pdf" target="_blank">
                     ...
                     <div class="subscribe-form fl-r">
                        <div role="form" class="wpcf7" id="wpcf7-f857-o1" lang="en-US" dir="ltr">
                           ...
                           <form action="https://cmclancaster.com/function.php" method="post" >
                              ...
                              <input type="hidden" name="redirect" value="https://cmclancaster.com/insurance-acceptance/"> 
